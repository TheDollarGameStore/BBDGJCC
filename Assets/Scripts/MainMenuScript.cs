...
public class MainMenuScript : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        InitializeCharacter(4, character5Button, PlayerPrefs.HasKey("unlockedCabbitsu"), "Cabbitsu, cabbitsu, cab-bit-su. LETTUSU, LETTUSU, LET-TU-SUHHH! Cabbitsu is the official Broccoli vs Burgers mascot. They will guide you through the game, celebrate your successes and console you through your failures. Make them proud!");

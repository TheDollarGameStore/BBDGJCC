...
public class MainMenuScript : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        InitializeCharacter(3, character4Button, PlayerPrefs.HasKey("unlockedGary"), "Pee-ew, who invited Gary Garlic? Why, you did of course, because of his amazing health benefits! Just a shame about the smell... Best to avoid any face to face conversations for a while. And to think, all Gary really wanted was a hug.");
        InitializeCharacter(4, character5Button, PlayerPrefs.HasKey("unlockedTommy"), "Tommy's therapist keeps telling him, if you keep everything bottled up inside, one day you'll explode! And judging by how quiet he's been lately, and how red he's getting in the face... You know what? I'm just going to take a step back...");
